process EMMTYPINGTOOL {
    ...
    tuple val(meta), path("emmtypingtool_EMM_TYPE"), emit: emmtypingtool_emm_type
    ...
    grep "Final_EMM_type" output_dir/*.results.xml | sed -n 's/.*value="\\([^"]*\\)".*/\\1/p' | tee emmtypingtool_EMM_TYPE
