...
def nextflow_runtime(
    ...
    min_proportion: int,
    trim_min_length: int,
    trim_quality_min_score: int,
    trim_window_size: int,
    read_processing: str,
    read_qc: str,
    fastp_args: str,
    assembler: typing.Optional[str],
    min_contig_length: int,
    quast_min_contig_length: int,
    spades_type: str,
    pilon_min_mapping_quality: int,
    pilon_min_base_quality: int,
    pilon_min_depth: float,
    pilon_fix: str,
    run_filter_contigs: bool,
    filter_contigs_min_length: int,
    filter_contigs_min_coverage: int,
    perform_characterization: bool,
    call_plasmidfinder: bool,
    call_kraken: bool,
    run_merlin_magic: bool,
    genome_annotation: str,
    bakta_db: str,
    midas_db: str,
    kraken_db: str,
    kmerfinder_db: str,
    gambit_db_genomes: str,
    gambit_db_signatures: str,
    bakta_db_path: str,
    abricate_db: str,
    amrfinder_min_percent_identity: float,
    amrfinder_min_percent_coverage: float,
    resfinder_min_percent_coverage: float,
    resfinder_min_percent_identity: float,
    plasmidfinder_min_percent_coverage: float,
    plasmidfinder_min_percent_identity: float,
    mlst_min_percent_identity: int,
    mlst_min_percent_coverage: int,
    mlst_minscore: int,
    kaptive_start_end_margin: int,
    kaptive_min_percent_coverage: int,
    kaptive_min_percent_identity: int,
    kaptive_low_gene_percent_identity: int,
    abricate_abaum_min_percent_identity: int,
    abricate_abaum_min_percent_coverage: int,
    lissero_min_percent_identity: int,
    lissero_min_percent_coverage: int,
    ectyper_o_min_percent_identity: int,
    ectyper_h_min_percent_identity: int,
    ectyper_o_min_percent_coverage: int,
    ectyper_h_min_percent_coverage: int,
    pbptyper_database: str,
    pbptyper_min_percent_identity: int,
    pbptyper_min_percent_coverage: int,
    emmtyper_wf: str,
    emmtyper_cluster_distance: int,
    emmtyper_min_percent_identity: int,
    emmtyper_culling_limit: int,
    emmtyper_mismatch: int,
    emmtyper_align_diff: int,
    emmtyper_gap: int,
    emmtyper_min_perfect: int,
    emmtyper_min_good: int,
    emmtyper_max_size: int,
    hicap_min_gene_percent_coverage: float,
    hicap_min_gene_depth: float,
    hicap_min_gene_length: int,
    hicap_min_gene_percent_identity: float,
    srst2_min_percent_coverage: int,
    srst2_max_divergence: int,
    srst2_min_depth: int,
    srst2_min_edge_depth: int,
    srst2_gene_max_mismatch: int,
    abricate_vibrio_min_percent_identity: int,
    abricate_vibrio_min_percent_coverage: int,
    virulencefinder_database: str,
    virulencefinder_min_percent_coverage: float,
    virulencefinder_min_percent_identity: float,
    tbp_parser_min_depth: int,
    tbp_parser_min_frequency: float,
    tbp_parser_min_read_support: int,
    tbp_parser_min_percent_coverage: int,
    tbp_parser_debug: bool,
    tbp_parser_rrs_frequncy: float,
    tbp_parser_rrs_read_support: int,
    tbp_parser_rr1_frequency: float,
    tbp_parser_rr1_read_support: int,
    tbp_parser_rpob499_frequency: float,
    tbp_parser_etha237_frequency: float,
    poppunk_gps_db_url: str,
    poppunk_gps_external_clusters_url: str,
    publish_dir_mode: str,
    ...
    cmd = [
        ...
        *get_flag('input', input_samplesheet),
                ...
                *get_flag('skip_screen', skip_screen, False),
                ...
                *get_flag('quast_min_contig_length', quast_min_contig_length, 500),
