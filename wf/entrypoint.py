...
import wf.upsert_to_registry as upsert_to_registry
...
#@small_task
#def return_table_id(table_id: int) -> None:
#    t = Table(id=str(table_id))
#    for page in t.list_records():
#        for id, record in page.items():
#            print(record)
